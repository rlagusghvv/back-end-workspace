 ...
 *  - 명시하지 않더라도 모든 클래스는 Object 클래스 상속 
 ...
 */
	...
	public Notebook(String brand, String pCode, String name, int price, String cpu) {
		// super : 해당 객체의 부모 객체 주소를 담고 있음 // super는 부모 클래스를 나타냄!
...
//	    super.pCode = pCode; // 부모가 default - 같은 패키지에 있어야만 직접 접근 가능!
	    super.name = name; // 부모가 protected - 상속관계일 때 자식 객체에서 직접 접근 가능! (다른 패키지여도!)
//	    super.price = price; // 부모가 private - 직접 접근 불가!
