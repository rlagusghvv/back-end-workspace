...
//         b.method1();
		 ...
		 * - 값(증감연산자) : 후위 연산으로 다른 연산을 모두 수행한 후 증감 연산을 수행
		 * 
		 */
	}
	...
	public void method1() {
	    ...
	    System.out.println("후위 연산자 적용 후 값 : " + number); // 14
	}
	public void method2() {
		int number = 20;
		int result = number++ * 3;
	    ...
	    System.out.println((number1++) + (--number2) + (number3--)); // 62 number1 = 13, number 2 = 20, number 3 = 29
//	    number1 = 13
//	    number 2 = 20
//	    number 3 = 29
