...
public class Application {
	 ...
	 * 객체 : 실제로 존재하는 것 
	 * 
	 * 객체 지향 프로그래밍(OOP, objected-Orientend Programming)
	 * - 프로그램을 개발하는 기법으로 객체들을 만들고 이러한 객체들을 연결하여 프로그램을 완성하는 기법
	 ...
	 * 추상화(Abstraction), 캡슐화(Encapsultaion)가 적용되어야함! 
	 */
	...
	public static void main(String[] args) {
        ...
        */
	    ...
	    Tv tv = new Tv(); // 다른 패키지에 있는 클래스는 import가 필요!
		/*
		 * JVM > Heap > Field, Method가 올라간다.
		 * JVM > Stack에 있는 변수에 주소값 할당
		 */
	    
	    System.out.println("TV의 전원 상태 : " + tv.power);
	    tv.power();
	    System.out.println("TV의 전원 상태 : " + tv.power);
	    ...
	    System.out.println("TV 채널 : " + tv.channel); // 10번
	}
