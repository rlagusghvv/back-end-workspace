...
//	return "결과값 : 몫은 " + (a/b) + "나머지는 " + (a%b);
	return "결과값 : 몫은 " + quotient(a, b) + " 나머지는 " + remainder(a,b);
	}
	 ...
	 */
        ...
        * - 반복문으로 바꿀 수 있으며 때떄로 반복문보다 성능이 나쁠 때도 있음
        * - 이해만 한다면 간결한 코드 작성이 가능
        */
