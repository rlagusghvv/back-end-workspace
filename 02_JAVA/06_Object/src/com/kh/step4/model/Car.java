...
public class Car {
	 ...
	 * [] default : 같은 패키지 내에서만 접근 가능! (명시하지 않음 - 기본값!)
	 * [-] private : 같은 클래스 내에서만 접근 가능! (가장 강력한 제한)
	 * 
	 * * 접근제어자를 사용하는 이유?
	 * - 외부로부터 데이터를 보호하기 위해서!
	 * - 외부에서는 불필요하고, 내부적으로만 사용되는 부분을 감추기 위해서
	 */
	// 원칙은 private으로 외부에서 변수에 접근 못하게 막아둠! 
	 ...
	 */
	 // 생성자 오버로딩!
	 public Car() {System.out.println("Hello");}
     ...
     public Car(String color, String gearType, int door) {
    	  ...
    	  * 모든 인스턴스 메서드에 지역변수로 숨겨진 채 존재 // 변수명이 같아 못찾는 이런 경우에 사용해줘야함! 
    	  */
    	 this.color = color; 
