...
public class A_String {
	...
	public void method1() {
		...
		System.out.println("str3 == str 4 : " + (str3 == str4)); // false
...
//		str2 = str + "!!!!!!";
		...
		// substring(int beginIndx, int endIndex) : String
		// 문자열의 beginIndex부터 endIndex - 1까지 (endIndex가 생략되는 경우 끝까지)
		// 의 문자열을 새로 생성해서 리턴
		String str3 = str.substring(7);
		String str4 = str.substring(0, 5);
		System.out.println("3. substring : " + str3); // Java!
		System.out.println("3. substring : " + str4); // Hello
		...
		System.out.println("4. indexOf : " + index2); // 7
		
		int index3 = str.indexOf("?");
		System.out.println("4. indexOf : " + index3); // -1 // 해당하는 문자열이 포함되어 있지 않는 경우
		
		// 5. replace(char oldChar, char newChar) : String
		// 문자열에서 old 문자를 new 문자로 변경한 새로운 문자열을 생성해서 리턴
		...
		System.out.println("6. toLowerCase : " + str7); // hello, java!
	...
	public void method4(){
		...
		String str = "HTML,CSS,JAVASCRIPT,MYSQL,JAVA,JDBC,SERVELT,JSP,JQUERY,MYBATIS,SPRING,REACT";
		
		// 1. String 클래스의 split 메서드 이용
		// split(String regex) : String[]
		// 입력받은 구분자로 문자열을 분리해서 문자열의 배열로 담아 리턴
	    ...
	    // hasMoreTokens : 꺼낼 수 있는 토큰이 있는지 확인 (남아있는 토큰이 있는지)
